...
public class SavingsAccountDTO {
    ...
    public SavingsAccountDTO(@NotNull Long primaryOwnerId, @NotNull Double balance, @NotNull String secretKey, @DecimalMax(value = "0.5", message = "The interest rate has to be less than 0.5") @DecimalMin(value = "0", message = "The interest rate has to be more than 0") Double interestRate, @DecimalMax(value = "1000.00", message = "The minimum balance has to be less than 1000") @DecimalMin(value = "100.00", message = "The minimum balance has to be more than 100") Double minimumBalance) {
        this.primaryOwnerId = primaryOwnerId;
        this.secondaryOwnerId = null;
        this.balance = new BigDecimal(balance);
        this.secretKey = secretKey;
        this.minimumBalance = new BigDecimal(minimumBalance);
        this.interestRate = new BigDecimal(interestRate);
    ...
    public SavingsAccountDTO(@NotNull Long primaryOwnerId, @NotNull Double balance, @NotNull String secretKey, @DecimalMax(value = "1000.00", message = "The minimum balance has to be less than 1000") @DecimalMin(value = "100.00", message = "The minimum balance has to be more than 100") BigDecimal minimumBalance){
        this.primaryOwnerId = primaryOwnerId;
        this.secondaryOwnerId = null;
        this.balance = new BigDecimal(balance);
        this.secretKey = secretKey;
    ...
    public SavingsAccountDTO(@NotNull Long primaryOwnerId, @NotNull Double balance, @NotNull String secretKey,@DecimalMax(value = "0.5", message = "The interest rate has to be less than 0.5") @DecimalMin(value = "0", message = "The interest rate has to be more than 0") Double interestRate ){
        this.primaryOwnerId = primaryOwnerId;
        this.secondaryOwnerId = null;
        this.balance = new BigDecimal(balance);
        this.secretKey = secretKey;
    ...
    public SavingsAccountDTO(@NotNull Long primaryOwnerId, @NotNull Double balance, @NotNull String secretKey) {
        this.primaryOwnerId = primaryOwnerId;
        this.secondaryOwnerId = null;
        this.balance = new BigDecimal(balance);
        this.secretKey = secretKey;
